...
testimonials = [
    "Elvis is a brilliant problem solver! His final year project was truly innovative. – Dr. Theodore",
    "Working with Elvis on the AI chatbot project was a pleasure. He's a dedicated and talented developer. – Alva victor (Team Member)",
]
